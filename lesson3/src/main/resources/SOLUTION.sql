...
ALTER TABLE mark ALTER COLUMN mark INT NOT NULL CHECK (mark BETWEEN 1 AND 10);
ALTER TABLE mark ALTER COLUMN student_id SET NOT NULL;
ALTER TABLE mark ALTER COLUMN subject_id SET NOT NULL;
ALTER TABLE subject ADD CONSTRAINT subjectcheck CHECK (grade BETWEEN 1 AND 5);
